...
public class Spike {
    ...
    public Spike(Context context){
        spike[0]= BitmapFactory.decodeResource(context.getResources(), R.drawable.pika);
        spike[1]= BitmapFactory.decodeResource(context.getResources(), R.drawable.pika1);
        spike[2]= BitmapFactory.decodeResource(context.getResources(), R.drawable.tim);
        random = new Random();
        resetPosition();
    }
